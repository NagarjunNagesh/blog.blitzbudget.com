                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 ml-auto mr-auto">
                            <h3 class="title">There is an inherent sense of suffering...</h3>
                            <p>
                                that encompasses all our living beings. Bogged
                                ...
                                moving away from? Where are you situated there?
                                <br>
                                <br>
                                ...
                                inevitably what we all start to propagate, and as a result, hate and resentment. That
                                would soon be the way we start seeing the world. And the more we hate, the more we
                                ...
                                <br>
                                <br>
                                And your choice to live a better life and shape your genes to be a little healthier will
                                force your future kids to have a healthier genes. Just a little bit better.
                                <br>
                                <br>
                                Such is the power of good habits and healthy thinking. Always see the light even during
...
export default {
    ...
    data() {
        return {
            audioPath: "https://audio.blitzbudget.com/psychology/why-we-all-suffer.mp3",
            form: {
                comment: "",
            },
            comments: [],
