<template>
  <div class="wrapper blog-post">
    <div class="page-header page-header-small rellax-header">
      <div class="page-header-image" style="background-image: url('img/psychology/vinsmoke-sanji.jpg')"></div>
      <div class="content-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            <h2 class="title">One Piece: Vinsmoke Sanji</h2>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              <h3 class="title">Sanji, A chef in Baratie is a peculiar character...</h3>
              <p>
                ...
                together and never comes in between them and their dreams. It is because of the promise that they could
                ...
                person who sees through the situation and intends to find the truth. Until then he is always seen as
                ...
                Brook that he would come back. This apparent change in the Sanji's heart is through a series of
                ...
                get Married to Pudding. What surprises the most is that Sanji almost with all his might hits Luffy
                intending to kill Luffy when Luffy comes to take back Sanji knowing that he is kidnapped. The decision
                of Sanji to harm Luffy even when Luffy refuses to hit Sanji shows that Luffy can see through people. It
                ...
                on the way to the wedding ceremony. His Brothers are brutal to him as well including his father Judge,
                ...
                moved more often than others who refuse to let the heart have its say but that is not a sign of strength
                ...
                Moreover, a person who gets happy by cooking delicious meals for others cannot ever be bad. But they can
                ...
                and anyone hungry. But it was not just that which forced Sanji to go back to Luffy and feed him. His
                ...
                helped right? He saw the side of Pudding where she is the sweetest personalty ever and Sanji saw the
                truth behind the deception where he sees through the inner desire of Pudding. It is revealed when he
                saves Pudding even after she tries to kill Sanji during the wedding. That truly breaks Pudding. The best
                of Sanji's character is shown at that moment when he chooses to help pudding despite her trying to kill
                him. The noblest of characteristics. A true character of the greatest chef.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <card type="blog" plain>
                    <div class="row">
                      <div class="col-md-7">
                        ...
                        <p class="card-description">
                          A fish-men karate expert and a former warlord now a part of the Straw hat pirate crew is
