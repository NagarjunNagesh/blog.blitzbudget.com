    ...
    <div class="container">
      ...
      <div class="row" id="modals">
        <div class="col-md-6 modal-buttons">
          <h4>Modal</h4>
          <n-button type="success" @click.native="modals.classic = true">
            <em class="now-ui-icons files_single-copy-04"></em> Classic
          </n-button>
          <n-button type="success" @click.native="modals.mini = true">
            <em class="now-ui-icons media-1_button-power"></em> Launch Modal
            Mini
          </n-button>
          <n-button type="success" @click.native="modals.notice = true">
            <em class="now-ui-icons travel_info"></em> Notice
          </n-button>
          <n-button type="success" @click.native="modals.login = true">
            <em class="now-ui-icons users_single-02"></em> Login Modal
          </n-button>
        </div>
