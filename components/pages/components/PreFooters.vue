        ...
        <div class="container">
          <div class="row justify-content-center">
            ...
            <n-button round class="btn-twitter">
              <em class="fab fa-twitter"></em> Twitter · 2.5k
            </n-button>
            <n-button round class="btn-facebook">
              <em class="fab fa-facebook-square"></em> Facebook · 3.2k
            </n-button>
            <n-button round class="btn-google">
              <em class="fab fa-google-plus"></em> Google · 1.2k
            </n-button>
            <n-button round class="btn-dribble">
              <em class="fab fa-dribbble"></em> Dribbble · 1.8k
            </n-button>
          </div>
        </div>
      </div>
