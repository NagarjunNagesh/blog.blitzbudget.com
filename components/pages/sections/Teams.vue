        ...
        <div class="row justify-content-center">
          <div class="col-md-4 ml-1">
            <card type="profile" plain>
              ...
              <h6 class="category text-success">Web Developer</h6>
          ...
          <div class="col-md-4 mr-1">
            <card type="profile" plain>
              ...
              <h6 class="category text-success">CEO / Co-Founder</h6>
              <p class="card-description">
          ...
          <div class="col-md-4 ml-1 mt-4">
            <card type="profile" plain>
              ...
              <h6 class="category text-success">Entrepreneur</h6>
              <p class="card-description">
              ...
              <div slot="raw-content" class="row">
                ...
                <div class="col-md-7">
                  <div class="card-body">
                    ...
                    <h6 class="category text-success">Landscape Architect</h6>
                    <p class="card-description">
              ...
              <div slot="raw-content" class="row">
                ...
                <div class="col-md-7">
                  <div class="card-body">
                    ...
                    <h6 class="category text-success">Legal Secretary</h6>
                    <p class="card-description">
        ...
        <div class="row">
          <div class="col-md-4">
            <card type="profile">
              ...
              <h6 class="category text-success">Credit Analyst</h6>
              <p class="card-description">
          ...
          <div class="col-md-4">
            <card type="profile">
              ...
              <h6 class="category text-success">Desktop Publisher</h6>
              <p class="card-description">
          ...
          <div class="col-md-4">
            <card type="profile">
              ...
              <h6 class="category text-success">Economist</h6>
              <p class="card-description">
