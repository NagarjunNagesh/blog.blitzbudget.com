          ...
          <div class="col-md-6 px-0">
            <card type="background" class="card-background-product card-no-shadow"
              ...
              <p class="card-description">
                Developed on the occasion of an exhibition of the same name, The
                City Lost & Found: Capturing New York...
              </p>
              <n-button type="danger" round>
                <em class="now-ui-icons ui-1_send"></em> View Book
              </n-button>
            </card>
          </div>
          <div class="col-md-6 px-0">
            <card type="background" raised class="card-background-product card-no-shadow"
              ...
              <p class="card-description">
                Satires, in the most basic definition, are works making fun of
                some sort of person or institution...
              </p>
              <n-button type="neutral" round>
                <em class="now-ui-icons ui-1_send"></em> View more
              </n-button>
            </card>
          </div>
          <div class="col-md-6 px-0">
            <card type="background" class="card-background-product card-no-shadow"
              ...
              <p class="card-description">
                ...
                are ones that have been made up...
              </p>
              <n-button type="neutral" round>
                <em class="now-ui-icons ui-1_send"></em> Read Now
              </n-button>
            </card>
          </div>
          <div class="col-md-6 px-0">
          ...
          <div class="col-md-4">
            <card plain>
              ...
              <p class="card-description">
                ...
                inspired by Google's material design. It's a great pleasure to
        ...
        <div class="section-story-overview">
          <div class="row">
            ...
            <div class="col-md-5">
              ...
              <p>
                Amber Lewis’s interior design blog takes you inside the creative
                workings of her Los Angeles–based studio. Keep an eye on this
                website for an industry insider’s point of view.
              </p>
            </div>
          </div>
        </div>
            ...
            <card type="background" class="card-fashion" style="background-image: url('img/project14.jpg')">
              <div class="card-body">
                ...
                <div class="card-footer text-left">
                  <div class="stats">
                    <span>
                      <em class="now-ui-icons objects_globe"></em>The “Crazy
                      idea” project
                    </span>
                  </div>
                </div>
              ...
              <div class="card card-fashion">
                ...
                <div class="card-body">
                  <div class="card-footer">
                    <div class="stats">
                      <span>
                        <em class="now-ui-icons education_paper"></em> The “I’m
                        on vacation” project
                      </span>
                    </div>
                  </div>
              ...
              <div class="card card-fashion arrow-left">
                ...
                <div class="card-body">
                  <div class="card-footer">
                    <div class="stats">
                      <span>
                        <em class="now-ui-icons design_app"></em>The "Agile
                        Project" project
                      </span>
                    </div>
                  </div>
          ...
          <div class="col-md-6 px-0">
            <card type="background" class="card-fashion" style="background-image: url('img/project16.jpg')">
              ...
              <div class="card-footer text-left">
                <div class="stats">
                  <span>
                    <em class="now-ui-icons media-2_sound-wave"></em>The
                    "Premortem" project
                  </span>
                </div>
              </div>
          ...
          <div class="col-md-5 ml-auto">
            <card type="background" raised class="card-background-product"
              ...
              <p class="card-description">
                ...
                Your Audience's Interests, Influence, Interactions, and Intent.
