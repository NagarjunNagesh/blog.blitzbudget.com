        ...
        <div class="row">
          <div class="col-md-4">
            <card type="testimonial" no-footer-line>
              ...
              <div slot="raw-content" class="icon icon-success">
        ...
        <div class="row">
          <div class="col-md-4">
            <card type="testimonial" plain>
              ...
              <h6 class="category text-success">Loan Counselor</h6>
              <p class="card-description">
          ...
          <div class="col-md-4">
            <card type="testimonial" plain>
              ...
              <h6 class="category text-success">Interpreter OR Translator</h6>
              <p class="card-description">
          ...
          <div class="col-md-4">
            <card type="testimonial" plain>
              ...
              <h6 class="category text-success">HR Specialist</h6>
              <p class="card-description">
